								...
								if (is_single()) { ?>
									<div class="taxonomia">
										...
										<div class="rango-precio">
											<?php
											try {
												echo get_the_term_list($post->ID, 'precio_receta', "Estado de animo: ", ', ', '');
											} catch (\Throwable $th) {
												echo $th;
											}
											?>
									...
									<div class="informacion-extra">
										<?php
										$calorias = get_post_meta(get_the_ID(), 'input-metabox', true);
										if ($calorias) {
										?>
											<div class="calorias">
										...
										?>
										<?php
										$calificacion = get_post_meta(get_the_ID(), 'dropdown-metabox', true);
										if ($calificacion) {
										?>
											<div class="calorias">
										...
										?>
										<?php
										$subtitulo = get_post_meta(get_the_ID(), 'textarea-metabox', true);
										if ($subtitulo) {
										?>
											<blockquote>
												<?php echo $subtitulo ?>
